...
const Header = () => {
    ...
    const scrollToSection = (href) => {setIsMenuOpen(false);
   ...
   <header className='relative z-50 px-6 py-7'>
        <div className='max-w-7xl mx-auto flex justify-between items-center'>
          ...
          <div className='text-white text-3xl font-black cursor-pointer'>
              PORTFOLIO  LUIS LEMOS<span className='text-primary'>.</span>
          </div>
      ...
      md:hidden ${  isMenuOpen ? 'translate-x-0' : 'translate-x-full'  } p-8 flex flex-col `}>
